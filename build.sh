...
go build -o ./dist/rye-$VERSION-macos-arm64/rye -tags "with_quic,with_utls,with_grpc,with_wireguard,with_dhcp,with_acme" -ldflags "-s -w -X github.com/larryzhao/rye.Build=$BUILD -X github.com/larryzhao/rye.Version=$VERSION" ./cmd/cli/...
